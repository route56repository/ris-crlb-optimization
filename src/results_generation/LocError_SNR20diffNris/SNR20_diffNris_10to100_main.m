...
Nris_vect=10:10:100;
Nris_RMSE_CRLB=nan(1,length(Nris_vect));
Nris_RMSE_SNR=nan(1,length(Nris_vect));
w=1;
for Nris=Nris_vect
    f = 28; j=sqrt(-1); Q=0.2;
    ...
    elseif Nris==30
        RMSEposcCRLB_30=RMSEposc_vect_CRLB_MC;
        RMSEposcSNR_30=RMSEposc_vect_SNR_MC;
    elseif Nris==40
        RMSEposcCRLB_40=RMSEposc_vect_CRLB_MC;
        RMSEposcSNR_40=RMSEposc_vect_SNR_MC;
    elseif Nris==50
        RMSEposcCRLB_50=RMSEposc_vect_CRLB_MC;
        RMSEposcSNR_50=RMSEposc_vect_SNR_MC;
    elseif Nris==60
        RMSEposcCRLB_60=RMSEposc_vect_CRLB_MC;
        RMSEposcSNR_60=RMSEposc_vect_SNR_MC;
    elseif Nris==70
        RMSEposcCRLB_70=RMSEposc_vect_CRLB_MC;
        RMSEposcSNR_70=RMSEposc_vect_SNR_MC;
    elseif Nris==80
        RMSEposcCRLB_80=RMSEposc_vect_CRLB_MC;
        RMSEposcSNR_80=RMSEposc_vect_SNR_MC;
    elseif Nris==90
        RMSEposcCRLB_90=RMSEposc_vect_CRLB_MC;
        RMSEposcSNR_90=RMSEposc_vect_SNR_MC;
    elseif Nris==100
        RMSEposcCRLB_100=RMSEposc_vect_CRLB_MC;
        RMSEposcSNR_100=RMSEposc_vect_SNR_MC;
    end

    Nris_RMSE_CRLB(w)=MC_RMSE_result_CRLB(end);
    Nris_RMSE_SNR(w)=MC_RMSE_result_SNR(end);
    w=w+1;
end

fig1=figure(1);
semilogy(Nris_vect, Nris_RMSE_CRLB,'-ob','LineWidth',1)
hold on
semilogy(Nris_vect, Nris_RMSE_SNR,'-og','LineWidth',1)
hold on
grid on
